...
//     one_piece::geometry::NanoPointList<3>, 3, long unsigned int>::KDTreeSingleIndexAdaptor()
    ...
    class KDTree
    {
        ...
        typedef nanoflann::KDTreeSingleIndexAdaptor<
            nanoflann::L2_Simple_Adaptor<double, NanoPointList<T> > ,
            NanoPointList<T>,
            T
            > NanoKDTree;
        ...
        void BuildTree(const VecXList &points)
        {
        ...
        void BuildTree(const VecList<T> &points)
        {
        ...
        void RadiusSearch(const VecX &point, std::vector<int> &indices, 
        ...
        void RadiusSearch(const VecX &point, std::vector<size_t> &indices, 
            std::vector<float > &dists, double radius, size_t max_result, 
            const SearchParameter &sp = SearchParameter())
        {
            if(point.rows() != T)
        ...
        void RadiusSearch(const Vec<T> &point, std::vector<int> &indices, 
            std::vector<float > &dists, double radius, size_t max_result, 
            const SearchParameter sp = SearchParameter())
        {
            std::vector<size_t> _indices;
        ...
        void RadiusSearch(const Vec<T> &point, std::vector<size_t> &indices, 
            std::vector<float > &dists, double radius, size_t max_result, 
            const SearchParameter sp = SearchParameter())
        {
        ...
        void KnnSearch(const VecX &point, std::vector<int> &indices, 
        ...
        void KnnSearch(const VecX &point, std::vector<size_t> &indices, 
            std::vector<float > &dists, int k, 
            const SearchParameter &sp = SearchParameter())
        {
            if(point.rows() != T)
        ...
        void KnnSearch(const Vec<T> &point, std::vector<int> &indices, 
            std::vector<float > &dists, int k, 
            const SearchParameter &sp = SearchParameter())
        {
            std::vector<size_t> _indices;
        ...
        void KnnSearch(const Vec<T> &point, std::vector<size_t> &indices, 
            std::vector<float > &dists, int k, 
            const SearchParameter &sp = SearchParameter())
        {
            indices.resize(k);
        ...
        void KnnRadiusSearch(const VecX &point, std::vector<int> &indices, 
        ...
        void KnnRadiusSearch(const VecX &point, std::vector<size_t> &indices, 
            std::vector<float > &dists, int k, float radius,
            const SearchParameter &sp = SearchParameter())
        {
            if(point.rows() != T)
        ...
        void KnnRadiusSearch(const Vec<T> &point, std::vector<int> &indices, 
            std::vector<float > &dists, int k, float radius,
            const SearchParameter &sp = SearchParameter())
        {
            std::vector<size_t> _indices;
        ...
        void KnnRadiusSearch(const Vec<T> &point, std::vector<size_t> &indices, 
            std::vector<float > &dists, int k, float radius,
            const SearchParameter &sp = SearchParameter())
        {
            indices.resize(k);
    ...
    {
        public:
        typedef nanoflann::KDTreeEigenMatrixAdaptor<Eigen::Matrix<double, 
        ...
        void BuildTree(const MatX &points)
        {
